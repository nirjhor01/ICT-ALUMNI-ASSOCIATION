    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-10">
                ...
                <form method="post" action="/Student/{{$students->id}}/block">
                    {{csrf_field()}}
                    @if($admin->isSuper==true)
                        @if($students->isBlocked==false)
                        <button class="btn pull-right btn-lg btn-danger">Block this student</button>
                            @else
                            <a href="/Student/{{$students->id}}/unblock" class="btn pull-right btn-lg btn-danger">Unblock this student</a>
                            @endif
                        @endif
                </form>
                ...
                <div class="col-lg-12  ml-auto">
                    <div class="register-form-wrap">
                        ...
                        <div class="register-form">
                            <form enctype="multipart/form-data" method="post" action="/Student/{{$students->id}}/update">
                                <div class="row">
                                    {{csrf_field()}}
                            ...
                            <form method="post" action="/Student/{{$students->id}}/delete">
                                {{csrf_field()}}
                                @if($admin->isSuper==true)
