                                                    ...
                                                    <div class="signin-area-wrap">
                                                        ...
                                                        <div class="sign-form">
                                                            <form action="{{ url("login/$url") }}" method="post" >
                                                                {{csrf_field()}}
                                                                <input name="RegNo" type="text" placeholder="Enter your Student ID">
                ...
                <form enctype="multipart/form-data" method="post" action="{{ url("register/$url") }}">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input required  type="email" class="form-control" id="register_email" name="email" />
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input required  type="password" class="form-control" id="register_password" name="password" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input required  data-toggle="datepicker"  type="text" class="form-control" id="dob" name="dob" />
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input required  type="text" class="form-control" id="county" name="county" />
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input required  type="text" class="form-control" id="register_stuid" name="register_stuid" />
                            </div>
                        </div>
                    </div>

                    <div class="form-group file-input ">
                        <input required type="file" name="cover_image" id="customfile" class="d-none" />
                    ...
                    <div class="gender form-group">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input required type="radio" id="register_gender_male" name="register_gender" value="male" class="custom-control-input" />
                            <label class="custom-control-label" for="register_gender_male">Male</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input c type="radio" id="register_gender_female" name="register_gender" value="female" class="custom-control-input">
