...
Route::get('/Student/{id}/verify','StudentsController@verify');
Route::get('/Student/{id}/view','StudentsController@view');
...
Route::get('/Alumni/{id}/view','AlumController@view');
Route::get('/Alumni/{id}/verify','AlumController@verify');
