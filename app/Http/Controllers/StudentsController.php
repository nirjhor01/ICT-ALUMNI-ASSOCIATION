...
class StudentsController extends Controller
{
    ...
    public function view($id)
    {
        ...
        $students = $students = Student::find($id);
        return view('students.admin_view')->with('students', $students);
    }
    ...
    public function verify($id)
    {
        ...
        $student->verification = "yes";
        $student->save();
        $posts = Student::orderBy('id', 'desc')->get();
        return Redirect::back()->with('message','Successfully Verified!');
        // return view('students.index')->with(['posts'=> $posts,'message'=>'Successfully Verified!']);
    }
